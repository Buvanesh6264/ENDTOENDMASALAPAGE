      ...
      <div className="content-container">
        <div className="text-section">
          ...
          <p className="description">
            ...
            industry with a investment of Rs. 50,00,000/- The founder Dr.R.
    ...
    <section className="hottest-recipes">
      ...
      <div className="recipe-container">
        <div className="recipe-image">
          <img src="https://www.whiskaffair.com/wp-content/uploads/2021/01/Chicken-Masala-2-3-1.jpg" alt="Chicken Curry" className="dish-image" />
        </div>

        <div className="recipe-details">
          <h3 className="recipe-title">Chicken Curry</h3>
          <p className="recipe-description">
            Aromatic and delectable, Chicken curry is cooked in coconut oil and curry leaves 
            followed by Abhirra Masala Chicken Curry.
          </p>
          <div className="recipe-links">
            {/* <a href="/" className="read-more">VIEW RECIPE →</a> */}
