  ...
  return (
    <div className="contact-page">
        ...
        <div class="contact-banner">
                    <img src="https://www.shutterstock.com/image-photo/contact-us-telephone-envelope-letter-260nw-2369194627.jpg" alt="Food Ingredients Market" class="contact-banner-image"/>
        </div>
